		...
		37: [function(t, e, r) {
			(function(e, n) {
				...
				n.prototype.slice = function(t, e) {
					...
					var i;
					if (n.TYPED_ARRAY_SUPPORT) i = this.subarray(t, e), i.__proto__ = n.prototype;
					else {
						var o = e - t;
						i = new n(o, void 0);
				...
				(function() {
					...
					function h(t) {
						...
						if (U && (U = [U]), q && !F && (F = e([q])), (v = /\bGoogle TV\b/.exec(F)) && (F = v[0]), /\bSimulator\b/i
							...
							else u(v = n.runtime) == _ ? (B = "Adobe AIR", z = v.flash.system.Capabilities.os) : u(v = n.phantom) ==
						...
						if (R && (v = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(R) || /(?:alpha|beta)(?: ?\d)?/i.exec(t + ";" +
							...
							"Firefox" == B && /\b(?:Android|Firefox OS)\b/.test(z)) B = "Firefox Mobile";
						else if ("Maxthon" == B && R) R = R.replace(/\.[\d.]+/, ".x");
						else if (/\bXbox\b/i.test(F)) "Xbox 360" == F && (z = null), "Xbox 360" == F && /\bIEMobile\b/.test(t) &&
							L.unshift("mobile mode");
						else if (!/^(?:Chrome|IE|Opera)$/.test(B) && (!B || F || /Browser|Mobi/.test(B)) || "Windows CE" != z && !
							/Mobi/i.test(t))
							if ("IE" == B && D) try {
								...
								v.name + ((v = v.version) ? " " + v : ""), w.test(B) ? (/\bIE\b/.test(v) && "Mac OS" == z && (z = null),
									...
									/\bIE\b/.test(v) && (z = null), D || (R = null)), U = ["Presto"], L.push(v));
							else B += " Mobile";
					...
					function A(t) {
						...
						if (t.opt.xmlns) {
							...
							if ("xmlns" === r)
								...
								else if ("xmlns" === n && t.attribValue !== z) k(t, "xmlns: prefix must be bound to " + z + "\nActual: " +
								t.attribValue);
							else {
								var i = t.tag,
			...
			(function(e, n) {
				...
				r.request = function(e, n, i) {
					...
					if (!a.content && X && "string" != typeof X && !n.isBuffer(X))
						if (G) X = a.nestedQuerystring ? qs.stringify(X) : querystring.stringify(X);
						else {
