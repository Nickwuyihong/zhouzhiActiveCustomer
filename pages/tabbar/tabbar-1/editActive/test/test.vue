	...
	<view v-else class="add_reward2">
		...
		<view class="inputs">
			...
			<!-- <input type="text" value="" placeholder="请输入优惠券可用时间" style="width: 70%;border-bottom: 1px solid #F2F2F2;" id="0"
			 v-on:input="setATime" /> -->
			  <time-template fields="second" start="2019-01-01 00:00:00" end="2030-12-30 23:59:59" :value="valueStart" @change="bindChangeStart"></time-template>
		</view>
		<view class="inputs">
			<view style="width: 30%;">券有效期：</view>
...
<script>
	import timeTemplate from "@/pages/components/time-template/time-template"
