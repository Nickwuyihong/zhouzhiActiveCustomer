<template>
	<view class="body">
		...
		<view class="title">活动集赞数量</view>
		<view class="activeName">
			<input type="text" :value="activeName" placeholder="请输入活动集赞数量" style="width: 90%;margin: auto;" v-on:input="setlikeNum"
			 v-model="likeNum" />
		</view>
		<view class="title">活动内容</view>

		<view v-if="ads.length==0" class="add_img">
			<view style="margin: auto;">广告内容选填</view>
